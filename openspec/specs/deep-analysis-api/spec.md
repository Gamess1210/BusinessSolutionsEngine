...
Defines the behaviour of the Deep Analysis API route — enforcing gate pre-conditions and `analysis_mode` server-side, invoking the deepAnalysisChain, persisting results to Supabase, and recovering safely from chain failures.
