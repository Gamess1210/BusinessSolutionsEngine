...
Defines the behaviour of the deepAnalysisChain — a two-call LangChain sequence that produces a deep brief and 5 ROI-framed solutions from an approved structured brief, using lazy model instantiation and reusable prompt templates.
